...
periodName = ["1950s", "1960s", "1970s", "1980s", "1990s", "2000s", "1010/14", "2015/19"]
...
for i in range(len(pricesHP)):
    minFailRate = 1 - (1 * ((1 - (minFPs[i] + addMinFP))**12))
    majFailRate = 1 - (1 * ((1 - (majFPs[i] + addMajFP))**12))
    ...
    print(f"\n{periodName[i]}")
    print(f"minFR: {minFailRate*100:.2f}% majFR: {majFailRate*100:.2f}% minFix: {minFixCost} majFix: {majFixCost}")
